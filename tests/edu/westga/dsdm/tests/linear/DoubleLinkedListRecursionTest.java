...
public class DoubleLinkedListRecursionTest {

	private DoubleLinkedListRecursion<Integer> oneElementList;
	private DoubleLinkedListRecursion<Integer> fiveElementList;

	@Before
	public void setUp() throws Exception {
		this.oneElementList = new DoubleLinkedListRecursion<Integer>();
		this.oneElementList.add(4);

	    this.fiveElementList = new DoubleLinkedListRecursion<Integer>();
