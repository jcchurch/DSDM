...
import edu.westga.dsdm.linear.List;

public class ArrayListTest {

	private List<Integer> oneElementList;
	private List<Integer> fiveElementList;

	@Before
	public void setUp() throws Exception {
		this.oneElementList = new ArrayList<Integer>(1);
		this.oneElementList.add(4);

	    this.fiveElementList = new ArrayList<Integer>(1);
